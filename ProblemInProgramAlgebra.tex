...
structure rig is defined as \inline{SemiringWithoutOne} where one represents the
multiplicative identity.
...
as a type (2,2,2) algebra in Agda standard library. The definition of loop
...
In some literature, nearring is defined in which multiplication is a
