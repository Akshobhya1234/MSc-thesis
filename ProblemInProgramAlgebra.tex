...
\end{minted} 
\inline{Rng} is defined as ringWihthoutOne where one is the multiplication identity.
\begin{minted}[breaklines,samepage]{Agda}
...
\end{enumerate}
In figure ~\ref{fig_nearring}, there are multiple definitions of the same structures
