...
product for these structures and derive proofs for some of the properties of
these structures.
\section{Definitions}
...
magma with left and right division identities. The operation $\backslash$ (left
division) and $/$ (right division) for elements $x,y$ in a quasigroup is defined
as:
