...
can be defined as a magma with left and right division identities. In other
words, a quasigroup is a set with a binary operation that satisfies the property
that for every element in the set, there is a unique element in the set that
