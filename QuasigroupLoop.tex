...
The definitions of quasigroup and loop monomorphism and isomorphism can be
defined similar to magma morphism discussed in Chapter 3. These definitions can
be found in the Agda standard library
\href{https://github.com/agda/agda-stdlib/blob/master/src/Algebra/Morphism/Structures.agda}{here}.
...
types of combinatorial designs. The proofs for properties of middle bol loop are
adapted from \cite{jaiyeola2021new}. Let $(M, ∙, /, \backslash)$ be a middle bol loop then the
...
The properties of Moufang loops have application in computational mathematics
...
\backslash)$ be a moufang loop then the following identities holds.
\begin{enumerate}
