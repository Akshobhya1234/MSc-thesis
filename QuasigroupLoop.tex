...
returns the largest of two \inline{Level}. The structure has five fields.
...
element. The morphism $f$ preserves all the binary operations as quasigroup
...
homogeneous binary relation (≈). We can define the composition for binary
operations homomorphism (∙) using transitive relation \inline{≈₃-trans} from Q₁
to Q₃ such that \[g (f ((Q₁ ∙ x) y)) ≈ (g ((Q₂ ∙ f x) (f y)) \text{ and } g ((Q₂ ∙ f x) (f
y))) ≈ ((Q₃ ∙ g (f x)) (g (f y)))\]
\[g (f ((Q₁ ∙ x) y)) ≈ ((Q₃ ∙ g (f x)) (g (f y)))\]
