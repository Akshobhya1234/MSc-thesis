...
\inline{IsMagma} with binary operation $∙$ and equivalence relation \inline{_≈_}. A
...
can be used with another character. To overcome this issue, for division operation,
...
We can form left and right divisions as:
...
\inline{\\-cong} and \inline{//-cong} fields are used to say that the division
...
\inline{LeftDivides} and \inline{RightDivides} above. We then open
...
Similarly, the composition of loop homomorphism is defined as:
