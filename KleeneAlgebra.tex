...
A Kleene Algebra over set S that is an idempotent semiring with $^{*}$
...
x⋆+xx⋆≈x⋆ x = begin
  ...
  1# + x * x ⋆ + (x * x ⋆ + x ⋆)    ≈⟨ +-assoc _ _ _ ⟩ 
  1# + (x * x ⋆ + (x * x ⋆ + x ⋆))  ≈⟨ +-congˡ (sym (+-assoc (x * x ⋆) (x * x ⋆) (x ⋆))) ⟩ 
...
\item
\begin{minted}[breaklines,samepage]{Agda}
x+[x+y]*[x+y]⋆+[x+y]⋆≈[x+y]⋆ : ∀ x y → x + (x + y) * (x + y) ⋆ + (x + y) ⋆ ≈ (x + y) ⋆
x+[x+y]*[x+y]⋆+[x+y]⋆≈[x+y]⋆ x y = begin
    x + (x + y) * (x + y) ⋆ + (x + y) ⋆             
      ≈⟨ +-assoc _ _ _ ⟩ 
    x + ((x + y) * (x + y) ⋆ + (x + y) ⋆)           
      ≈⟨ +-congˡ (+-comm _ _) ⟩ 
    x +  ( (x + y) ⋆ + (x + y) * (x + y) ⋆)         
      ≈⟨ +-congˡ (x⋆+xx⋆≈x⋆ _) ⟩
    x + (x + y) ⋆                                   
      ≈⟨ +-congˡ( sym(starExpansiveˡ _)) ⟩
    x +  ((1# + (x + y) ⋆ * (x + y)) + (x + y) ⋆)   
      ≈⟨ (sym(+-assoc x ((1# + (x + y) ⋆ * (x + y)) ) ((x + y) ⋆))) ⟩
    x + (1# + (x + y) ⋆ * (x + y)) + (x + y) ⋆      
      ≈⟨ +-congʳ(sym(+-assoc _ _ _)) ⟩ 
    x + 1# + (x + y) ⋆ * (x + y) + (x + y) ⋆              
      ≈⟨ +-congʳ(+-congʳ (+-comm x 1#)) ⟩ 
    1# + x + (x + y) ⋆ * (x + y) + (x + y) ⋆              
      ≈⟨ +-congʳ ( +-congˡ (distribˡ _ _ _)) ⟩ 
    1# + x + ((x + y) ⋆ * x + (x + y) ⋆ * y ) + (x + y) ⋆ 
      ≈⟨ +-congʳ (+-assoc _ _ _) ⟩ 
    1# + (x + ((x + y) ⋆ * x + (x + y) ⋆ * y ))+ (x + y) ⋆ 
      ≈⟨ +-congʳ (+-congˡ (+-congʳ (sym(*-identityˡ x)))) ⟩ 
    1# + ( 1# * x  + ((x + y) ⋆ * x + (x + y) ⋆ * y )) + (x + y) ⋆ 
      ≈⟨ +-congʳ (+-congˡ (sym(+-assoc _ _ _))) ⟩ 
    1# + ((1# * x + ((x + y) ⋆ * x)) + (x + y) ⋆ * y ) + (x + y) ⋆ 
      ≈⟨ +-congʳ (+-congˡ (+-congʳ (sym(distribʳ _ _ _)))) ⟩ 
    1# + ( (1# + (x + y) ⋆) * x + (x + y) ⋆ * y )+ (x + y) ⋆  
      ≈⟨ +-congʳ (+-congˡ (+-congʳ (*-congʳ (1+x⋆≈x⋆ _ )))) ⟩ 
    1# + ( (x + y) ⋆ * x + (x + y) ⋆ * y )+ (x + y) ⋆ 
      ≈⟨ +-congʳ (+-congˡ (sym(distribˡ _ _ _))) ⟩ 
    1# + ( (x + y) ⋆ * (x + y )) + (x + y) ⋆ 
      ≈⟨ starExpansiveˡ _ ⟩ 
    (x + y) ⋆ 
      ∎

[x+y]⋆≈[x+y]⋆x+[x+y]⋆ : ∀ x y → (x + y) ⋆ ≈ (x + y) ⋆ * x + (x + y) ⋆
[x+y]⋆≈[x+y]⋆x+[x+y]⋆ x y = sym(starDestructiveˡ (x + y) x ((x + y) ⋆) (x+[x+y]*[x+y]⋆+[x+y]⋆≈[x+y]⋆ x y))
\end{minted}
\end{enumerate}