...
\begin{itemize}
    ...
    condition. \[\frac{p t}{p(t[xs \mapsto ts])}\]
\end{itemize}
...
of sorts and $F$ is set of operation names. An operation can be defined as a triple
...
\begin{itemize}
    ...
    \[g_1 \equiv g_2 \Rightarrow g_1\textsubscript{-1} = g_2\textsubscript{-1}
    \forall g_1,g_2 \in G\]
