...
\begin{itemize}
    ...
    \item The direct sum of two algebraic structures $A$ and $B$ is an algebra
    denoted as $A \bigoplus B$. The underlying set of $|A \bigoplus B|$ is the
    disjoint union of the underlying sets of $A$ and $B$, and the operations are
    defined separately on each component. If $A$ has operations $f_1, f_2, ...
    f_n$ and $B$ has operations $g_1,g_2, ... g_2$, then $A \bigoplus B$ has
    operations $f_1, f_2, ... f_n,g_1,g_2, ... g_2$ defined component-wise
    \cite{directproduct}. 
