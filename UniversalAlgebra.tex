...
\begin{itemize}
    ...
    congruence relation $(\cong)$ is defined as $(S_Q,F_Q,E_Q)$ where $S_Q$ is
    the factor set of $S$ such that: \[S_Q = \{[x] | x \in S\}\] The operations
    $op_Q$ in the quotient algebra is defined as: \[op_Q\ [x_1]...[x_n] = [op\
    x_1 ... x_n]\] where $op_Q \in F$ and $op \in F$. $[x]$ denotes the
    equivalence class such that \([x] = \{y \in S | x \cong y\}\).
    ...
    from indexing set $I$ to $\bigcup A_i$ such that $i \in I, a(i) \in A$. The
