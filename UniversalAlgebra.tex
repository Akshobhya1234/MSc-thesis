...
Agda in the later chapters. Section \ref{universe} defines equational first
order logic, signature, algebra, and theory. We introduce constructs such as morphisms and
direct product in Section \ref{construct}. The definitions in this chapter are
adapted from \cite{sankappanavar1981course}, \cite{YSharoda}, and
