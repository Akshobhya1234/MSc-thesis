...
The Coq specification language is called Gallina. Users can write functions and
...
and gives a brief overview of the syntax used in the definition. We note the
files in which algebra definitions can be found in each system. We intentionally
keep some overlap from the previous chapter when discussing the definition of
monoid in Agda to have uniform coverage for each system.
