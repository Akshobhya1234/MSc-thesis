...
regular expression will find the make use of the keyword used in each system to
...
\begin{itemize}
  ...
  all the definitions in that version are considered. 
...
In this section, we see characterization of monoid structure in
