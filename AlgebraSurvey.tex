...
convert objects of type \inline{law} into objects of type \inline{T -> T -> T}.
...
type \inline{t} that wishes to be an instance of \inlineCode{Idris}{Monoid} must
also satisfy the requirements of the Semigroup interface.
\inlineCode{Idris}{neutral} represents the identity element for the binary
operation defined on type \inline{t}.
\inlineCode{Idris}{monoidNeutralIsNeutralL} and
