...
level. The module result type \inline{Set _}, where the underscore represents a
universe level that will be inferred. \inline{flip} is a function to flip the
...
\MYhref{https://github.com/agda/agda-stdlib/issues/1907}{issue} in standard
