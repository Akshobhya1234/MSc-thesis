...
products of appropriate algebras and addresses them as direct products. In many
cases, the bi-product coincides with the direct product when certain conditions
...
\mintinline[breaklines,breakafter=.]{Agda}{Algebra.Construct.DirectProducts} in Agda standard library. The product
of magma structure is defined as:
