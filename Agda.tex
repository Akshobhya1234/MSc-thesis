...
\inline{true}. In Agda, when pattern matching, cases are tried in order from
top to bottom. This equation does not hold definitionally. Agda will split this
...
\inline{A} and \inline{B} are carrier set over arbitrary universe level. The
